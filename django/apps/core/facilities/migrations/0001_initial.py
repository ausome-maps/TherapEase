    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('images', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(blank=True, null=True), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='facilities', to='facilities.facilityproperties')),
            ],
            options={
