...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='organization',
            options={'ordering': ['-create_date'], 'permissions': (('manage_organization', 'Can manage organization'), ('manage_organization_members', 'Can manage members to organization'), ('manage_organization_facilities', 'Can manage facilities of the organization')), 'verbose_name_plural': 'Organizations'},
        ),
